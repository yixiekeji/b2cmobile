<template>
	<view class="searchResult">
		...
		<view class="couponsContent" v-for="item in list">
			<view>
			...
			<view style="width: 100%;display: flex;justify-content: space-between;">
				<view style="display: flex;align-items: center;color: #DC3A2F;font-size: 26rpx;">
					...
					<button v-if="item.linkProduct != 1" class="watch" @click="jumpPage(item.id,item.couponName,item.useEndTime,item.couponValue,item.minAmount,item.linkProduct)">查看</button>
				</view>
				<view>
